    ...
    <div className="w-full my-6 rounded-3xl bg-[#0e1626]/95 border border-white/10 p-5 sm:p-7 shadow-2xl backdrop-blur-xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 pb-4 border-b border-white/10">
        <div>
          ...
          <h3 className="text-xl font-bold text-white font-serif tracking-tight mt-1">
            Customize Highway Climate & Ambient Sounds
          </h3>
        </div>
        ...
        >
          ...
          <span>2:30 AM Highway Tea Stop ☕</span>
        </motion.button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-3">
          <label className="text-xs font-mono text-neutral-400 uppercase tracking-wider block">
            Select Journey Atmosphere (Time & Weather)
          </label>
          <div className="grid grid-cols-3 gap-3">
            ...
            >
              ...
              <div className="text-center">
                <div className="text-xs font-bold font-mono">Midnight (01:30 AM)</div>
                <div className="text-[10px] opacity-75 font-mono">NH-44 Highway</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-center">
                <div className="text-xs font-bold font-mono">Sunset (06:45 PM)</div>
            ...
            >
              ...
              <div className="text-center">
                <div className="text-xs font-bold font-mono">Morning Fog (04:30 AM)</div>
                <div className="text-[10px] opacity-75 font-mono">Mountain Mist</div>
              </div>
            </button>
          </div>
        ...
        <div className="space-y-4 bg-[#0a0f1a]/80 p-4 rounded-2xl border border-white/10">
          <label className="text-xs font-mono text-neutral-400 uppercase tracking-wider block">
            Ambient Audio Synthesizer Layers (Highway Soundscape)
          </label>
          ...
          <div>
            <div className="flex justify-between text-xs font-mono text-neutral-300 mb-1">
              <span className="flex items-center gap-1.5">
                ...
                Vintage Cassette Tape Magnetic Hiss
              </span>
      ...
      {showChaiModal && (
        <div className="fixed inset-0 bg-[#070a12]/85 backdrop-blur-xl z-50 flex items-center justify-center p-4">
          ...
          >
            {/* Dhaba Neon Sign */}
            <div className="px-4 py-1.5 rounded-full bg-[#ff7b00]/20 text-[#ff9500] font-bold border border-[#ff7b00]/40 text-xs inline-flex items-center gap-1.5 font-mono mb-3">
              <Sparkles className="w-3.5 h-3.5 text-[#ff7b00]" />
              <span>SHER-E-PUNJAB HIGHWAY REST STOP (24x7 OPEN)</span>
            </div>
            ...
            <div className="my-4 flex flex-col items-center justify-center">
              ...
              <div className="text-xs text-[#ff9500] font-mono mt-2 animate-pulse">
                ~ Steaming Hot Ginger Cardamom Tea ~
              </div>
            </div>

            <h4 className="text-xl font-bold text-white font-serif">
              "Two Special Ginger Teas and Butter Parathas, Please!"
            </h4>
            <p className="text-xs text-neutral-300 mt-2 font-baskerville italic leading-relaxed">
              The night bus has stopped for a 20-minute tea halt. Cool mountain fog rolls in as tired passengers sip piping hot ginger tea from earthen cups under warm halogen lamps.
            </p>
